    ...
    <div className="font-['PlusJakartaSans',_Inter,_sans-serif] bg-white text-[#18181B] min-h-screen">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-8 py-20 bg-[#FAFAFA]">
        ...
        <div className="max-w-xl w-full">
          <h1 className="text-5xl md:text-6xl font-extrabold text-[#18181B] mb-6 leading-tight">Custom IPL Hair Removal Devices.</h1>
          <p className="text-lg text-[#52525B] mb-8">Best Niche Market for Cosmetic Brands: At-Home Hair Removal Devices. We help you design it, build it and box it.</p>
