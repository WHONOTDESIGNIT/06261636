...
const SmartAppIPL = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      SEOTags,
      {
        title: "Smart App IPL Device | App-Controlled Hair Removal System",
        description: "App-controlled IPL device for personalized hair removal. Smart scheduling, usage tracking, and remote control via mobile app.",
        keywords: "smart app IPL, app-controlled IPL, personalized hair removal, mobile app IPL, smart IPL device"
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-white pt-20", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
