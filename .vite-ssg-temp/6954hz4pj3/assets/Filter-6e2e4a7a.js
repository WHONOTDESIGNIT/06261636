    ...
    /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-r from-purple-600 to-pink-600 text-white py-20", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-5xl font-bold mb-6", children: t("accessories.filter.hero.title") }),
          /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl max-w-3xl mx-auto text-gray-100 mb-10", children: t("accessories.filter.hero.subtitle") })
        ]
      }
    ) }) }),
