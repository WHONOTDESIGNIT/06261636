...
import { u as useLanguage, H as HomePage } from "../main.ssg.mjs";
...
const CountryPage = () => {
  ...
  const updateMetaTags = (countryCode2) => {
    ...
    const metadata = countryMetadata[countryCode2] || {
      title,
      description
    };
    ...
    addOrUpdateMeta("geo.region", countryCode2.toUpperCase());
    addOrUpdateMeta("geo.position", getCountryPosition(countryCode2));
    addOrUpdateMeta("ICBM", getCountryPosition(countryCode2));
    updateHreflangTags();
  };
  const getCountryPosition = (countryCode2) => {
    const positions = {
      us: "39.8283, -98.5795",
      gb: "55.3781, -3.4360",
      de: "51.1657, 10.4515",
    ...
    return positions[countryCode2] || "0, 0";
  };
